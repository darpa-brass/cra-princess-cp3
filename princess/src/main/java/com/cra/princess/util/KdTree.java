...
public abstract class KdTree<T> {
    ...
    /**
     * Returns all points within 'distLimit' of 'location'
     */
    @SuppressWarnings("unchecked")
    public List<Entry<T>> pointsWithinDist(double[] location, double distLimit, boolean sequentialSorting) {
        KdTree<T> cursor = this;
        cursor.status = Status.NONE;
        double range = distLimit;
        ResultHeap resultHeap = new ResultHeap(this.sizeLimit);
