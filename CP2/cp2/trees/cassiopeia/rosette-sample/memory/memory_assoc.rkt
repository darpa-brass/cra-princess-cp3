...
(define MEM (assoclist (for/list ([i 8]) (cons (bv i bitwidth) (bits*)))))
...
(define (ST Raddr Rval)
  (assoclist-set MEM (unbox Raddr) (unbox Rval)))

(define (LD Rd Raddr)
  (set-box! Rd (MEM (unbox Raddr))))
