 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2098013409
 * Seed:      2098013409
 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_17[6][1][2] = {{{(-1L),(-1L)}},{{(-1L),(-1L)}},{{(-1L),(-1L)}},{{(-1L),(-1L)}},{{(-1L),(-1L)}},{{(-1L),(-1L)}}};
    int i, j, k;
    (*g_4) = (safe_rshift_func_int16_t_s_s(0x17BEL, 15));
    for (g_5 = 0; (g_5 < (-7)); g_5 = safe_sub_func_uint64_t_u_u(g_5, 3))
    { /* block id: 4 */
        uint64_t l_8 = 0xAA61FC2DA8AFC1DALL;
        int32_t *l_9 = &g_10;
        int32_t *l_11 = &g_12;
        (*l_11) = ((*l_9) = l_8);
    }
    ...
    { /* block id: 10 */
        int32_t *l_15 = (void*)0;
        int32_t *l_16[1][4][10] = {{{&g_5,&g_12,&g_10,&g_10,&g_12,&g_5,&g_10,(void*)0,&g_10,(void*)0},{&g_5,&g_10,&g_10,&g_12,&g_10,&g_10,&g_5,&g_10,&g_5,&g_5},{&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_12,&g_10},{&g_5,&g_5,&g_5,&g_12,&g_5,&g_10,&g_12,&g_10,&g_5,&g_12}}};
        int i, j, k;
        l_17[5][0][1] &= 0xD3335637L;
        return g_10;
    }
    return l_17[3][0][0];
}
