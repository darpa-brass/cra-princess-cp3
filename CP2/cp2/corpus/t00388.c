 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1081512827
 * Seed:      1081512827
 */
...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_5 = {0L,0x8A94B2AB76D6092FLL,0x44ACCB24L,0xE55459EEL,0xA5L};/* VOLATILE GLOBAL g_5 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[4] = {0x5EFA20BDL,0x5EFA20BDL,0x5EFA20BDL,0x5EFA20BDL};
    int i;
    ++l_2[3];
    return g_5;
}
