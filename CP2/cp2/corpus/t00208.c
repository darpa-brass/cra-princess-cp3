 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1566471405
 * Seed:      1566471405
 */
...
static union U4 g_10 = {0x263DL};/* VOLATILE GLOBAL g_10 */
...
static union U4  func_1(void)
{ /* block id: 0 */
    int32_t l_7 = 0x6F65E790L;
    int32_t *l_8 = &g_9;
    (*l_8) |= (safe_mul_func_int8_t_s_s(g_4, (safe_mul_func_uint16_t_u_u(l_7, l_7))));
    return g_10;
}
