 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1219733364
 * Seed:      1219733364
 */
...
static int32_t g_12[7] = {0x90EF307DL,0x90EF307DL,0x90EF307DL,0x90EF307DL,0x90EF307DL,0x90EF307DL,0x90EF307DL};
...
{ /* block id: 0 */
    uint32_t l_5 = 1UL;
    for (g_2 = 0; (g_2 != 8); g_2 = safe_add_func_int8_t_s_s(g_2, 4))
    { /* block id: 3 */
        int32_t *l_6 = (void*)0;
        int32_t *l_7 = &g_8;
        (*l_7) ^= l_5;
