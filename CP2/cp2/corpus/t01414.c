 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3200018429
 * Seed:      3200018429
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x37BC7528L;
static int32_t g_6 = 9L;
static volatile int16_t g_7 = 0x927FL;/* VOLATILE GLOBAL g_7 */
static volatile uint16_t g_8 = 4UL;/* VOLATILE GLOBAL g_8 */
