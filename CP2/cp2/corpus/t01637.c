 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1797862768
 * Seed:      1797862768
 */
...
static volatile int32_t g_11[7] = {0x42FF18C9L,0x42FF18C9L,0x42FF18C9L,0x42FF18C9L,0x42FF18C9L,0x42FF18C9L,0x42FF18C9L};
...
{ /* block id: 0 */
    ...
    int32_t *l_9[7][5];
    int32_t l_12 = (-1L);
    uint16_t l_13[8] = {65535UL,65535UL,0x05F6L,65535UL,65535UL,0x05F6L,65535UL,65535UL};
    int i, j;
    for (i = 0; i < 7; i++)
    {
        for (j = 0; j < 5; j++)
...
XXX times a pointer is qualified to be dereferenced: 160
