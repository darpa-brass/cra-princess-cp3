 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 4154342360
 * Seed:      4154342360
 */
...
/* --- GLOBAL VARIABLES --- */
static const volatile uint16_t g_2 = 5UL;/* VOLATILE GLOBAL g_2 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t *l_3[4] = {&g_4,&g_4,&g_4,&g_4};
    int i;
    g_4 = g_2;
    return g_2;
}
