 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1954490610
 * Seed:      1954490610
 */
...
static int32_t g_8 = 0x5A9CEA44L;
...
{ /* block id: 0 */
    ...
    if ((l_4 = 0xA7275995L))
    { /* block id: 2 */
        int64_t l_5 = 0x594D0357257EA0D0LL;
        int32_t l_6[10] = {2L,2L,2L,2L,2L,2L,2L,2L,2L,2L};
        uint16_t l_9 = 0UL;
        int i;
        ++l_9;
