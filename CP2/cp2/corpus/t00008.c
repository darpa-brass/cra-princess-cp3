 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 4145701851
 * Seed:      4145701851
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_8 = 0x90F1D898L;
static int32_t *g_7[4][1] = {{&g_8},{&g_8},{&g_8},{&g_8}};
...
{ /* block id: 0 */
    ...
    int32_t *l_11 = &g_8;
    l_11 = ((*l_10) = func_2((safe_rshift_func_uint8_t_u_s(l_6, 2))));
    return (**l_10);
}
