 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1605366966
 * Seed:      1605366966
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x9C9FB37BL;
...
{ /* block id: 0 */
    ...
    ++g_5;
    l_3[4][0] = (void*)0;
    for (g_5 = 17; (g_5 < 34); g_5 = safe_add_func_uint32_t_u_u(g_5, 1))
    { /* block id: 5 */
        for (g_4 = (-30); (g_4 > 8); ++g_4)
        { /* block id: 8 */
            if (g_5)
                break;
            return g_5;
