 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2282890053
 * Seed:      2282890053
 */
...
static volatile uint8_t g_7 = 0xBDL;/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    ...
    const uint32_t l_10[10][1] = {{0x58BFC4F2L},{0x0315362DL},{0x58BFC4F2L},{0x0315362DL},{0x58BFC4F2L},{0x0315362DL},{0x58BFC4F2L},{0x0315362DL},{0x58BFC4F2L},{0x0315362DL}};
    int i, j;
    g_7--;
    return l_10[8][0];
}
