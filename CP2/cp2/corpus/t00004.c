 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3444945076
 * Seed:      3444945076
 */
...
static uint16_t g_3 = 0x63ABL;
static int32_t g_5 = 0x3203BD65L;
static struct S0 g_6 = {6};
