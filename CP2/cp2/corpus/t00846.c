 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1974119229
 * Seed:      1974119229
 */
...
static int32_t g_7 = 0xED6F1860L;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_6 g_8 g_3
 * writes: g_7
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x3CF95751L;
    (*g_6) = (((g_2 != (void*)0) , 0x47L) > l_4);
    (*g_8) = l_4;
    return g_3;
}
