 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 424843637
 * Seed:      424843637
 */
...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4 = {18446744073709551609UL,0x37186542L};/* VOLATILE GLOBAL g_4 */
static volatile struct S0 g_6 = {2UL,1UL};/* VOLATILE GLOBAL g_6 */
...
{ /* block id: 0 */
    struct S0 *l_3 = &g_4;
    struct S0 **l_2[7] = {&l_3,&l_3,&l_3,&l_3,&l_3,&l_3,&l_3};
    int32_t l_7 = 0x2BD42CA8L;
    int i;
    g_5 = (void*)0;
    return l_7;
}
