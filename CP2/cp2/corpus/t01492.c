 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 624423011
 * Seed:      624423011
 */
...
{ /* block id: 0 */
    uint32_t l_3[3];
    int32_t l_5 = 0x196EE4E9L;
    int i;
    for (i = 0; i < 3; i++)
        l_3[i] = 0xECCCE1E2L;
    l_5 = (g_2 >= (l_3[1] || ((1L | ((~(0x928FL >= (-6L))) , (l_3[1] <= g_2))) , ((g_2 != 0x21E9L) & l_3[1]))));
    return l_3[0];
}
