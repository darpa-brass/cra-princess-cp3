 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2013761603
 * Seed:      2013761603
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xBF079684L;
static uint32_t g_9 = 0UL;
static struct S1 g_12 = {6288,53};/* VOLATILE GLOBAL g_12 */
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = (void*)0;
    int32_t *l_5 = &g_3;
    int32_t l_6 = 0x9BEAB1D6L;
    int32_t *l_7[7];
    int32_t l_8 = 0x94BB489FL;
    int i;
    for (i = 0; i < 7; i++)
        l_7[i] = &l_6;
    g_9++;
