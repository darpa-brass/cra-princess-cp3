 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3448744795
 * Seed:      3448744795
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x34D8A94BL;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 0L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = (-8L);
static struct S3 g_8 = {5523,-73,15,13};/* VOLATILE GLOBAL g_8 */
