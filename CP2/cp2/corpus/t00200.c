 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1909851111
 * Seed:      1909851111
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[5] = {0x5934215EL,0x5934215EL,0x5934215EL,0x5934215EL,0x5934215EL};
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3[3];
    int32_t *l_5 = &g_3[1];
    int32_t *l_6[10] = {(void*)0,&g_3[2],&g_3[2],(void*)0,&g_3[2],&g_3[2],(void*)0,&g_3[2],&g_3[2],(void*)0};
    int32_t l_7 = 1L;
    uint64_t l_8 = 0x7E9F21C9B6CD04CDLL;
    int i;
    l_8++;
