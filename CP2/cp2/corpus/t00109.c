 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3112449993
 * Seed:      3112449993
 */
...
static int32_t g_12 = 0x73D5943EL;
static struct S0 g_13 = {0,50,0x4DDBL,1240,852,0,-7L,0xD7C869B7L,-1597,20747};/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    int32_t *l_11 = &g_12;
    (*g_3) = l_2;
    (*l_11) = (((*l_9) = (safe_sub_func_uint16_t_u_u(((*l_7) = ((g_4 != 0xEEL) ^ g_4)), g_4))) | l_2);
    return g_13;
}
