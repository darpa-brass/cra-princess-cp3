 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2759027919
 * Seed:      2759027919
 */
...
static int64_t g_4 = 0xEF2C36544D1878ABLL;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    const volatile int32_t * volatile *l_3[5] = {&g_2,&g_2,&g_2,&g_2,&g_2};
    int i;
    g_2 = g_2;
    return g_4;
}
