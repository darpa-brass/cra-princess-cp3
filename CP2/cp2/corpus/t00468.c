 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2180072612
 * Seed:      2180072612
 */
...
static volatile uint64_t g_4 = 0x22E6E7F737A9A971LL;/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    int i;
    --g_4;
    for (g_3 = (-11); (g_3 >= 6); g_3 = safe_add_func_int8_t_s_s(g_3, 8))
    { /* block id: 4 */
        uint16_t l_9[8] = {3UL,65535UL,3UL,65535UL,3UL,65535UL,3UL,65535UL};
        int i;
        ++l_9[7];
    }
    return g_3;
