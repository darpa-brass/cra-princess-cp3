 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3166707755
 * Seed:      3166707755
 */
...
static int32_t g_4[2][3] = {{0xBD4DFBD6L,0L,0xBD4DFBD6L},{0xBD4DFBD6L,0L,0xBD4DFBD6L}};
static int32_t * volatile g_3 = &g_4[0][2];/* VOLATILE GLOBAL g_3 */
...
static const struct S0  func_1(void)
{ /* block id: 0 */
    const struct S0 l_5 = {416,10915,99};
    (*g_3) = (g_2 , g_2);
    return l_5;
}
