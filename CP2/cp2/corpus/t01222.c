 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2190695619
 * Seed:      2190695619
 */
...
static const volatile int32_t * volatile g_2[1] = {&g_3};
...
static int64_t  func_1(void)
{ /* block id: 0 */
    const volatile int32_t * volatile *l_4 = (void*)0;
    const volatile int32_t * volatile l_5 = &g_3;/* VOLATILE GLOBAL l_5 */
    l_5 = g_2[0];
    return (*l_5);
}
