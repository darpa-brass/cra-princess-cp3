 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 1342207065
 * Seed:      1342207065
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 0x45DB34E6L;/* VOLATILE GLOBAL g_2 */
...
{ /* block id: 0 */
    ...
    g_8 ^= ((*l_5) = ((g_2 , l_3[0][2]) , 0xD9BA07E4L));
    (*l_5) = (*l_5);
    (*l_5) &= g_8;
    return g_8;
}
