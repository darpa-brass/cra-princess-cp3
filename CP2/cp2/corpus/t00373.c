 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 4186836371
 * Seed:      4186836371
 */
...
static int32_t * volatile g_8 = &g_3;/* VOLATILE GLOBAL g_8 */
...
static const int16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[8] = {0x3A4DF6F9L,0x01D91E66L,0x3A4DF6F9L,0x01D91E66L,0x3A4DF6F9L,0x01D91E66L,0x3A4DF6F9L,0x01D91E66L};
    int32_t *l_7 = (void*)0;
    int i;
    for (g_3 = 7; (g_3 >= 0); g_3 -= 1)
    { /* block id: 3 */
        const int32_t l_4 = 0x028F4E1CL;
        return l_4;
    }
    for (g_3 = 7; (g_3 >= 0); g_3 -= 1)
    { /* block id: 8 */
