 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 2065600201
 * Seed:      2065600201
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile struct S1 g_3 = {1};/* VOLATILE GLOBAL g_3 */
static volatile struct S1 *g_2 = &g_3;
static struct S3 g_5 = {3614,-60,14,-3,-4289,3003,47,18446744073709551607UL,317};/* VOLATILE GLOBAL g_5 */
