 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 4052208817
 * Seed:      4052208817
 */
...
static volatile union U0 *g_8 = (void*)0;
static volatile union U0 ** const  volatile g_9 = &g_8;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    int8_t l_2[4];
    int32_t l_5 = 0x1B66BAFCL;
    int i;
    for (i = 0; i < 4; i++)
        l_2[i] = 1L;
    l_5 = (l_2[2] && (+g_4));
    for (l_5 = 0; (l_5 > 17); l_5 = safe_add_func_int8_t_s_s(l_5, 9))
    { /* block id: 4 */
        (*g_9) = g_8;
        if (g_4)
            break;
