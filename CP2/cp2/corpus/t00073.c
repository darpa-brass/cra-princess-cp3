 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 532114271
 * Seed:      532114271
 */
...
static uint32_t g_6[5] = {0xBEDCC590L,0xBEDCC590L,0xBEDCC590L,0xBEDCC590L,0xBEDCC590L};
