 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3619831184
 * Seed:      3619831184
 */
...
static volatile uint16_t g_5 = 0x5342L;/* VOLATILE GLOBAL g_5 */
