 ...
 * Git version: 30dccd7
 * Options:   --take-no-union-field-addr --no-packed-struct --no-float --seed 3062072849
 * Seed:      3062072849
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[8][1] = {{0x1B66BAFCL},{5L},{0x1B66BAFCL},{5L},{0x1B66BAFCL},{5L},{0x1B66BAFCL},{5L}};
static volatile int32_t g_3 = (-1L);/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0x173948B0L;
