...
lazy val root = (project in file("."))
  ...
  .settings(publish := {})
  .dependsOn(princess, kalmanfilter, localizationalgorithm, remus, evaluation, kalmanfiltercomponent, remusclient, mockwebservice, remusviewer, pathplanner)
  .aggregate(princess, kalmanfilter, localizationalgorithm, remus, evaluation, kalmanfiltercomponent, remusclient, mockwebservice, remusviewer, pathplanner)
